 ...
 * the same prefix: `/totec/chatgpt-local-files/src/main/patch.ts` where `src/main/patch.ts`
 ...
 *
 * The workspace learned from `/totec/chatgpt-local-files/src/main/patch.ts` should be the
...
export interface Workspace {
  /** Virtual path of the folder, e.g. `/totec/chatgpt-local-files`. */
  virtual: string;
  real: string;
  at: number;
}
