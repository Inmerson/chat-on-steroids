/**
 * Adapted from Chat On Steroids upstream v2.0.9 Code Mode, which in turn is inspired by
 * OpenAI Codex's bounded code-mode composition model. See docs/licenses/codex/README.md.
 *
 * Trusted Node bootstrap only. Model source executes inside a fresh bounded QuickJS WASM
 * runtime; the bridge crosses JSON strings only and never exposes host objects.
 */
