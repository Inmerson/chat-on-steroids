 ...
 */
export const CONNECTOR_BRAND = 'ChatGPT Local Files';
 ...
 *    which is off by default. A user who never enables it pays nothing for it here,
...
const CORE: SurfaceDefinition = {
  id: 'core',
  serverName: 'chatgpt-local-files-core',
 ...
 * separately and usually leaves off; its two schemas are the largest we publish, since
...
const DESKTOP: SurfaceDefinition = {
  id: 'desktop',
  serverName: 'chatgpt-local-files-desktop',
