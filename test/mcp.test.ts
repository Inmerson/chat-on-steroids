...
describe('surface boundaries', () => {
  ...
  it('keeps the worst-case no-query discovery of each surface small', async () => {
    ...
    expect(coreTools).toHaveLength(66);
    expect(desktopTools).toHaveLength(61);
    ...
    expect(coreBytes, `core tools/list is ${coreBytes} bytes`).toBeLessThan(160_000);
    expect(desktopBytes, `desktop tools/list is ${desktopBytes} bytes`).toBeLessThan(150_000);
